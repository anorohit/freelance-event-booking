...
export function HorizontalScrollCarousel({
  ...
  const EventCard = ({ event }: { event: Event }) => (
    <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-blue-500/10 dark:hover:shadow-blue-400/10 overflow-hidden h-full flex flex-col flex-shrink-0 w-[280px] sm:w-[300px]">
    ...
    <section className="relative">
      ...
      <div className="relative group">
        ...
        <Button
          ...
          className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm shadow-lg border-0 w-10 h-10 rounded-full p-0 transition-all duration-300 ${
            canScrollLeft
              ? "opacity-0 group-hover:opacity-100 hover:shadow-xl hover:scale-110"
        ...
        <Button
          ...
          className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm shadow-lg border-0 w-10 h-10 rounded-full p-0 transition-all duration-300 ${
            canScrollRight
              ? "opacity-0 group-hover:opacity-100 hover:shadow-xl hover:scale-110"
              : "opacity-0 cursor-not-allowed"
          } hidden sm:flex items-center justify-center`}
        ...
        >
          {events.map((event) => (
            <div key={event.id} style={{ scrollSnapAlign: "start" }} className="flex-shrink-0">
